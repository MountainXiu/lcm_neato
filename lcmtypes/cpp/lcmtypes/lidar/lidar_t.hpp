...
#ifndef __lidar_lidar_t_hpp__
#define __lidar_lidar_t_hpp__
...
int lidar_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->range_min, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->range_max, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int lidar_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->range_min, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->range_max, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x01490b20baf5e38dLL;
